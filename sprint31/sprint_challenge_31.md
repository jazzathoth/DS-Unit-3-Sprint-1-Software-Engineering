...
*Hint* - `random.randint` should be able to serve your random number ne .
...
- What, in your opinion, is an important part of code reviews? That is, what is
  ...
  when others do the same for your code?
	...
	*This time, one of the most important things I was looking at and wanted*
	*my review partner to look at on mine is if it looked like I understood*
	*the main concepts from this week*

	*Another thing that I think is important in general is to just tell someone
	*what they are doing right or wrong. I alwas like the reassurance that*
	*someone else likes the way I approached something, but would always *
	*appreciate it if they shared a better way to do it if they know of one*
	*It also helps to be able to have a conversation during the review*
	*process

- We have an awful lot of computers here, and it gets pretty confusing with
  slightly different things running on all of them. How could containers help us
  improve this situation?
	*We could create a standard container via a dockerfile. That can ensur*
	*that code is always developed and tested in the same environment.*
	*Then, when going to deploy, any time there is a problem we have a*
	*baseline system to compare too and see what is different.*
	*Containerizing code also helps with the development process. *
	*It lets different people with different systems work on a *
	*piece of code in identical environments.*
